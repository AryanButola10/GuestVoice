        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm">
              ...
              <div className="w-full h-48 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-600 rounded-lg flex items-center justify-center">
                <p className="text-slate-400 dark:text-slate-500 text-sm text-center px-6">
                  Input panel
                </p>
              </div>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  ...
                  <p className="text-slate-900 dark:text-slate-100 font-semibold text-xl">{stat.value}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm">
            <h2 className="text-slate-800 dark:text-slate-100 font-semibold text-sm mb-4">Analysis Results</h2>
            <div className="h-32 flex items-center justify-center bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-100 dark:border-slate-600">
